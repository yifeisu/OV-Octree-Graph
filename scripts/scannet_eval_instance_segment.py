...
def test_pipeline_full_scannet200_mgl(cfg):
    ...
    # voc feature
    l_vocab_features = np.load(f"./tiger/evaluation/voc_features/scannet200_clip_l_14_vild.npy")
    h_vocab_features = np.load(f"./tiger/evaluation/voc_features/scannet200_clip_h_14.npy")
    # 200 -> 600 id mapper
